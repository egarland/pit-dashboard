 ...
 */
export interface BTFSValueMap2062 {
    /**
     * 
     * @type {string}
...
/**
 * Check if a given object implements the BTFSValueMap2062 interface.
 */
...
export function BTFSValueMap2062FromJSON(json: any): BTFSValueMap2062 {
    return BTFSValueMap2062FromJSONTyped(json, false);
}

export function BTFSValueMap2062FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTFSValueMap2062 {
...
export function BTFSValueMap2062ToJSON(value?: BTFSValueMap2062 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
